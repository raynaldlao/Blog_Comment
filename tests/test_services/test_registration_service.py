...
def test_create_account_success(db_session):
    ...
    user = registration_service.create_account("new_user", "password123", "new_user@test.com")
...
def test_create_account_username_already_exists(db_session):
    ...
    registration_service = RegistrationService(db_session)
    result = registration_service.create_account("existing_user", "new_password", "other@test.com")
...
def test_create_account_email_already_exists(db_session):
    ...
    registration_service = RegistrationService(db_session)
    result = registration_service.create_account("user_two", "password", "taken@test.com")
