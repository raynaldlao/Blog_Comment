...
class Comment(Base):
    ...
    Attributes:
        ...
        comment_reply_to (int | None): Foreign key referencing a
        parent comment (for replies).
        comment_content (str): Text content of the comment.
        comment_posted_at (datetime): Automated timestamp of when the
        comment was posted.
        ...
        reply_to_comment (Comment | None): Relationship to the
